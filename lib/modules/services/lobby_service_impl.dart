...
mutation CreateLobby($createLobbyInput: CreateLobbyInput!) {
  ...
  @override
  Future<GeneralResponse<dynamic>> createLobby(String subject) async {
    try {
      final MutationOptions options = MutationOptions(
        document: gql(loginMutation),
        fetchPolicy: FetchPolicy.noCache,
        variables: {
          "createFlashCardSetInput": {"subject": subject},
        },
      );
